  ...
  return (
    <Layout canGoBack>
      <div className="px-4  py-4">
        <div className="mb-8">
          <img src={`https://imagedelivery.net/c4VdxCUMvR6vZ0u_H6JJsw/${data?.product.image}/public`} className="h-96 bg-slate-300" />
          <div className="flex cursor-pointer py-3 border-t border-b items-center space-x-3">
            <img 
            src={`https://imagedelivery.net/c4VdxCUMvR6vZ0u_H6JJsw/${data?.product.user.avatar}/avatar`}
